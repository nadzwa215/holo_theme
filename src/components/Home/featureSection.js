      ...
      <div className="max-w-7xl mx-auto lg:px-8 md:px-3">
        <div className="mx-auto max-w-7xl px-4 mt-10 lg:mt-12 flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-1/2 text-center lg:text-right flex flex-col justify-center">
            <h3 className="text-black text-4xl lg:text-6xl font-bold font-['Poppins'] text-gradient bg-gradient-to-r from-lightGreen to-green">
            ...
            <div className="mt-6 flex justify-center lg:justify-end">
              <a
                href="/gallery"
                className="border-2 border-lightGreen hover:bg-green text-black hover:text-white px-6 py-3 rounded-lg font-bold transition-all duration-300 inline-flex items-center"
              >
                View Gallery
