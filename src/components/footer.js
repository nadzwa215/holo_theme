...
const Footer = () => {
  // URL Google Maps untuk Saiga Stable
  ...
  return (
    <div className="m-4">
      <div className="max-w-7xl mx-auto mt-16 h-auto">
        ...
        <div className="footer bg-gray-50 border-2 border-green p-8 rounded-2xl shadow-lg">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="text-center lg:text-left">
              <div className="flex justify-center lg:justify-start items-center space-x-4">
                ...
                />
                <div>
                  <h3 className="text-2xl font-bold text-green font-['Poppins']">
                    Saiga Stable
                  </h3>
                  <p className="text-green text-sm mt-1 opacity-80">dengan semangat.</p>
              ...
              <p className="text-green text-sm mt-4 italic leading-relaxed opacity-80">
            ...
            {/* Contact Info dengan alignment yang sejajar */}
            <div className="text-center lg:text-right">
              ...
              <div className="space-y-3 text-sm text-green">
                ...
                <div className="flex items-center justify-end space-x-2 text-black">
                  <span className="w-2 h-2 bg-green rounded-full opacity-80 flex-shrink-0"></span>
                  <a 
                    href="mailto:saigastableteam@gmail.com"
                    className="hover:opacity-100 transition-opacity duration-300 opacity-80 text-left text-green"
                ...
                <p className="text-xs italic mt-4 leading-relaxed opacity-80 text-right">
